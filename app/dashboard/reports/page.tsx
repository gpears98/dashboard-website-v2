...
const stats: Stat[] = [
  ...
  { label: 'Net Weekly Sales', value: '$79.29k', labelBadge: '+2%', valueBadge: '↑'},
  { label: 'Net Monthly Sales', value: '$187.93k', labelBadge: '-7%', valueBadge: '↓'},
  { label: 'Net Annual Sales', value: '$1.32M', labelBadge: '+1', valueBadge: '↑'},
  { label: 'Monthly Profit', value: '$129.84k', labelBadge: '+3', valueBadge: '↑'},
